...
vcc & vcc & vcc & NOT \RD_n~dataout\ & NOT \A~dataout\(5) & \A~dataout\(1) & NOT \IORQ_n~dataout\ & \A~dataout\(4) & NOT \A~dataout\(0) & NOT \A~dataout\(7) & NOT \A~dataout\(3) & \A~dataout\(6) & \A~dataout\(2) & \SPI_en_s~dataout\);
...
vcc & vcc & vcc & NOT \RD_n~dataout\ & NOT \A~dataout\(5) & \A~dataout\(1) & NOT \IORQ_n~dataout\ & \A~dataout\(4) & NOT \A~dataout\(0) & NOT \A~dataout\(7) & NOT \A~dataout\(3) & \A~dataout\(6) & \A~dataout\(2) & NOT \SPI_RDY~dataout\);
