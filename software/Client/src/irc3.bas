10 BLOAD"msxpi-io.bin":CLS:CH$="#openmsx":NK$="* msxpi *"
20 PRINT "MSXPi IRC Client"
21 print:print "1=Talk  2=Join  3=Bye":print
22 print "Don't use Function Keys."
23 print "Use Numeric keys 1,2,3":print
29 REM Define FN Keys and Constants
30 BUF=&HC000:DEF USR0=&HB000:DEF USR1=&HB003:gosub 10000:gosub 30000
40 FOR I=1 TO 10: KEY(I) OFF:NEXT I 
...
1300 rem ON KEY GOSUB 11000,12000,15000i
1310 PRINT
1400 rem KEY (1) ON:KEY (2) ON:KEY (3) ON
1410 TIME=0
1420 I$=INKEY$
1430 IF I$="1" THEN GOSUB 11000:GOTO 1470
1440 IF I$="2" THEN GOSUB 12000:GOTO 1470
1450 IF I$="3" THEN GOTO 15000
1460 IF TIME < 150 THEN GOTO 1420
1465 REM KEY (1) OFF:KEY (2) OFF:KEY (3) Off
1470 COM$="IRC READ":GOSUB 50000
1480 COM$="IRC GETRSP":GOSUB 50000:if RC=EB then goto 1400
1490 if bs>254 then gosub 52030 else print RC$
1500 goto 1400
...
50120 NEXT I
50130 GOSUB 53000:A=USR1(0):RC=PEEK(BUF):if RC<>E0 THEN RETURN
