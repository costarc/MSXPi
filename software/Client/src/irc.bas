...
50120 NEXT I
50130 CALL MSXPISEND("B000"):GOSUB 53000
50131 OUT (&H5A),0:GOSUB 53000:RC=INP(&H5A)
50140 IF RC=&HE9 THEN GOSUB 53000:OUT (&H5A),0:GOSUB53000:RC=INP(&H5A)
50160 POKE (BUF),RC
50165 PRINT(HEX$(RC))
50170 IF RC = E0 THEN GOSUB 51000
50180 RETURN
51000 CALL MSXPIRECV("B000"):GOSUB 52000
51010 RETURN
