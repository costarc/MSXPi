10 BLOAD"msxpiext.bin",r:CLS:CH$="#msxpi":NK$="* msxpi *"
...
1200 if bs>254 then PR=1:gosub 52030 else print rc$
1210 COM$="IRC JOIN "+CH$:GOSUB 50000
1220 IF RC<>E0 AND RC<>EB THEN END
1230 COM$="IRC GETRSP":GOSUB 50000
1260 if bs>254 then PR=1:gosub 52030 else print rc$
1300 ON KEY GOSUB 11000,12000,13000,14000,15000
1310 FOR I=1 TO 10: KEY(I) ON:NEXT I:TIME=0
1400 ' FOR I=1 TO 10: KEY(I) ON:NEXT I:TIME=0
1410 TIME=0
1450 IF TIME < 150 THEN GOTO 1450
1455 'FOR I=1 TO 10: KEY(I) STOP:NEXT I:
...
10090 KEY 10,""
10100 RETURN
11000 m$="":PRINT"talk:|";chr$(8);:time=0:GOSUB 20000
...
20100 for i = 0 to len(m$)+4:print " ";chr$(8);chr$(8);:next i:return
30000 REM
30110 E0 = &HE0
30120 E1 = &HE1
30130 E2 = &HE2
