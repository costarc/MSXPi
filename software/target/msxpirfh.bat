...
pcopy https://github.com/costarc/MSXPi/raw/master/software/target/msxpiupd.ba?raw=true
pcopy https://github.com/costarc/MSXPi/raw/master/software/target/msxpiupd.tmp.ba?raw=true
